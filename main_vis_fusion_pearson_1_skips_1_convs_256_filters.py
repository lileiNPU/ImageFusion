...
for batch_image_ir, batch_image_vis in train_loader:
    ...
    if b_counter < 10:
        cv2.imwrite(fuse_image_save_path + '/img_0'+ str(b_counter) + '_pearson_1_skips_1_convs_256_filters.png', img_fusion)
    else:
        cv2.imwrite(fuse_image_save_path + '/img_' + str(b_counter) + '_pearson_1_skips_1_convs_256_filters.png', img_fusion)
